      ...
      {modelDetail?.applied_simulation_filter ? (
        <>
          <Descriptions.Item
            label="Depth range"
            span={1.5}
          >{`${modelDetail?.depth_range_min} - ${modelDetail?.depth_range_max} meters`}</Descriptions.Item>
          <Descriptions.Item
            label="Screen length range"
            span={1.5}
          >{`${modelDetail?.unsat_range_min} - ${modelDetail?.unsat_range_max} meters`}</Descriptions.Item>
        </>
      ) : null}
